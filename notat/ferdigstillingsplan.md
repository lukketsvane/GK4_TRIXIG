...
├── skisser/                             ← rådata, 130+ skisser
├── teardown/                            ← OpenSCAD-utkast, USDZ-modell
├── ikea_profil/                         ← brand-grunnlag
├── kursmateriale/                       ← orginale kursdokument
├── trixig/                              ← orginale produktdokument
├── leveransar/                          ← nytt: berre eksporterte PDF/PPT for Moodle
